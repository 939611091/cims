                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <button type="button" class="btn btn-danger" onclick="window.location='${contextPath}/teacher/course/printStudentList?id=${course.id}'"><i class="fa fa-fw fa-search"></i>打印课程考勤表</button>&nbsp&nbsp&nbsp
                            </div>
                            <!-- /.box-header -->

            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${pageContext.request.contextPath }/admin/admin/editAdmin.do" method="post" >
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group" id="realname">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="真实姓名" name="name" value="${admin.name }">
                                    </div>
                                </div>
                                <div class="form-group" id="phone">
                                    <label  class="col-sm-2 control-label">电话</label>
                                    <div class="col-sm-8">
                                        <input type="tel" class="form-control"  placeholder="电话" name="aPhone"  value="${admin.aPhone }">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->

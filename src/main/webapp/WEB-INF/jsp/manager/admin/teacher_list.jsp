                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">老师信息管理</h3>&nbsp&nbsp&nbsp&nbsp
                                <button type="button" class="btn btn-danger" onclick="location.href='${contextPath}/admin/teacher/addTeacher';"><i class="fa fa-fw fa-search"></i>录入老师信息</button>&nbsp&nbsp&nbsp
                                <h3 class="box-title">${msgSuccess}${msgError}</h3>
                                <div class="box-tools pull-right">
                                    <form action="${contextPath}/admin/teacher/list" method="post" id="search">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-default"
                                                onclick="location.href='${contextPath}/admin/teacher/list';">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered">
                                        <tbody>
                                            ...
                                            <c:forEach items="${pageResult.list }" var="teacher">
                                            <tr align="center">
                                                ...
                                                <td><fmt:formatDate value="${teacher.updateTime}"
                                                                    pattern="yyyy年MM月dd日 "/></td>
                                                <td class="mailbox-date">
                                                     <div class="btn-group">
                                                        <button type="button" class="btn btn-default" onclick="window.location='${contextPath}/admin/teacher/editTeacher?id=${teacher.teacherId}'">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="${contextPath}/admin/teacher/delete.do?id=${teacher.teacherId}" onclick= "return confirm('确认删除？');">删除</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <ul class="pagination pagination-sm no-margin pull-right">
                                            <li ${pageResult.hasPreviousPage? "":"class='disabled'"}>
                                                <c:if test="${pageResult.hasPreviousPage}">
                                                    <a href="${contextPath}/admin/teacher/list?pageNum=${pageResult.prePage}">上一页</a>
                                                </c:if>
                                                <c:if test="${!pageResult.hasPreviousPage}">
                                                    <span>上一页</span>
                                                </c:if>
                                            ...
                                            <c:forEach items="${pageResult.navigatepageNums}" var="num">
                                                <li ${pageResult.pageNum == num ? "class='active'":""}>
                                                    <a href="${contextPath}/admin/teacher/list?pageNum=${num}">${num}</a>
                                                </li>
                                            </c:forEach>
                                            <li ${pageResult.hasNextPage? "":"class='disabled'"}>
                                                <c:if test="${pageResult.hasNextPage}">
                                                    <a href="${contextPath}/admin/teacher/list?pageNum=${pageResult.nextPage}">下一页</a>
                                                </c:if>
                                                <c:if test="${!pageResult.hasNextPage}">
                                                    <span>下一页</span>
                                                </c:if>

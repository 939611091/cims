            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/admin/plan/addPlan.do" method="post" id="add_user" >
                            <div class="box-body">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" name="classroomId">
                                            ...
                                            <c:forEach items="${classroomList}" var="classroomList">
                                                <option value="${classroomList.id}">教室名：${classroomList.classroomName},教室容量：${classroomList.capacity}</option>
                                            </c:forEach>
                                        </select>
                                    </div>

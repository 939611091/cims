...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>老师管理</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/admin/teacher/addTeacher.do" method="post" enctype="multipart/form-data" id="add_user" >
                            <div class="box-body">
                                ...
                                <div class="form-group" id="phone">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="tel" class="form-control"  placeholder="电话" name="phone">
                                    </div>
                                </div>
                                <div class="form-group" id="tDescription">
                                    <label  class="col-sm-2 control-label">老师简介</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control"  name="tDescription" placeholder="老师简介" ></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right">添加老师</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>

                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">添加管理员</h3>&nbsp&nbsp&nbsp
                            <h3 class="box-title">${msgError}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/admin/admin/addAdmin.do" method="post" id="add_user" onsubmit="return doSubmit()">
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" class="btn btn-info pull-right">添加管理员</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>

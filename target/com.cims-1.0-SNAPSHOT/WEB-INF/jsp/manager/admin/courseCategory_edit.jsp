            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <%--ID要传出来，不然更新不了 ，把on去掉--%>
                        <form class="form-horizontal" action="${contextPath}/admin/courseCategory/edit.do" method="post" id="add_user" >
                            ...
                            <div class="box-body">
                                <div class="form-group" id="classroomName">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="课程类别名" name="categoryName" value="${course_category.categoryName }">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->

                    ...
                    <div class="box box-info">
                        <div class="box box-info">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title">安排教室</h3>&nbsp;&nbsp;&nbsp;
                                <h3 class="box-title">${msgError}${msg}</h3>
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/admin/plan/editPlan.do" method="post" id="add_user" >
                            <div class="box-body">
                                <input type="hidden" name="courseId" value="${course_classroom.courseId }" />

                                <div class="form-group" id="course">
                                    <label class="col-sm-2 control-label">选择教室</label>
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" name="classroomId">
                                            <option value="-1" selected="selected" disabled>选择教室</option>
                                            <c:forEach items="${classroomList}" var="classroomList">
                                                <option value="${classroomList.id}" ${classroomList.id == course_classroom.classroomId?"selected":""}>教室名：${classroomList.classroomName},教室容量：${classroomList.capacity}</option>
                                            </c:forEach>
                                        </select>
                                    </div>

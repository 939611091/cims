...
<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>CI</b>MS</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Course</b>IMS</span>
    </a>
...
<%--                </li>--%>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">用户名：${sessionScope.teacher.username}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <span>${sessionScope.teacher.name}</span>
                                <%--                                <small>${'权限：'}</small>--%>
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="${contextPath}/teacher/exit" class="btn btn-default btn-flat">注销</a>
